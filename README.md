...
We used **Shanghai - pudonghuinan** as the target air quality monitoring station.
...
| **City** | Shanghai |
| **Street** | Pudonghuinan |
| **AQICN URL** | `https://api.waqi.info/feed/@10186` |
...
|--------|-------------|-----------|--------|
| **MSE** | 980.0497 | **679.3747** | ↓ −30.69% |
| **R²** | -0.4122 | **0.0211** | ↑ closer to 0 |
...
✍️ *Author: Wenbo Xia & Zhouya Shen (KTH ID2223 — Lab 1 Air Quality Project, 2025)*
